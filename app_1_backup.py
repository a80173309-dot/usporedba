...
# ==============================
# UPLOAD I USPOREDBA S AUTOMATSKIM REFRESH
# ==============================
...
def upload():
    ...
    if request.method == "POST":
        ...
        # Render stranice sa automatskim refreshom nakon 3 sekunde
        return render_template("rezultat.html", result_file=f"results/rezultat_{uid}.xlsx")
